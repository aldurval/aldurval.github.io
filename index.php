...
<body>
    ...
    <div id="fundo">
        <img src='img/fundo_inde.png' heigth="1000px" />
    </div>
</div>
...
<div id="site" class='span4 col-lg-4 '>
        ...
        <fieldset>
            ...
            <div class='form-danger'>
                ...
                <a style="float:left; font-size: 11px; color: black;" href="esqueci.php">Esqueci meus dados</a>
            </div><br>            <br><br>
            <input class="btn btn-mini btn-danger btn-lg  pull-right"type="submit" value="&nbsp;Entrar&nbsp;"  name="buttonLogar">
            <br>
            <fieldset>
